...
export default function About () {
    ...
    return (
        <div className="main">
            ...
            <p>The Landlord Report Card uses data from the City of Albany. All grades are assigned automatically based on <a href="https://en.wikipedia.org/wiki/Academic_grading_in_the_United_States#Rank-based_grading">Rank-Based Grading</a> using standard deviations. The overall grade is an average of the component grades.</p>
