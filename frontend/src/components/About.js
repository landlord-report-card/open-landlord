...
export default function About () {
    ...
    return (
        <div className="main">
            ...
            <p>All grades are assigned automatically using <a href="https://en.wikipedia.org/wiki/Academic_grading_in_the_United_States#Rank-based_grading">Rank-Based Grading</a> using standard deviations. The top grade, A, is given for performance that exceeds the mean by more than 1.5 standard deviations, a B for performance between 0.5 and 1.5 standard deviations above the mean, and so on. 
